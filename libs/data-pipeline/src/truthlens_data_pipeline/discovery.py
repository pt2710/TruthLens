...
def _bootstrap_templates() -> list[dict[str, Any]]:
    return [
        ...
        {
            "title": "Emergency alert says tonight changes everything",
            "description": "A panic-heavy packaging pattern that leans on urgency and vague authority instead of verifiable sourcing.",
            "tags": ["emergency", "alert", "urgent"],
            "hashtags": ["#urgent", "#alert"],
            "transcript": "The host repeats that officials know what is coming tonight but refuses to cite a document, source, or confirmed statement.",
            "template_cluster": "emergency-alert-panic",
            "thumbnail_signal": {
                "saturation": 0.89,
                "contrast": 0.85,
                "text_density": 0.8,
                "face_emphasis": 0.71,
                "shock_indicator": 0.91,
            },
            "risk_seed": 0.93,
            "mismatch_seed": 0.81,
        },
        {
            "title": "Official teaser breakdown confirms the ending leak",
            "description": "A promo-shaped clickbait pattern that borrows franchise authority, leak framing, and false certainty.",
            "tags": ["official teaser", "ending leak", "confirmed"],
            "hashtags": ["#teaser", "#confirmed"],
            "transcript": "The narration insists the ending leak is real even though the actual footage and sources do not support the claim.",
            "template_cluster": "teaser-ending-leak",
            "thumbnail_signal": {
                "saturation": 0.86,
                "contrast": 0.82,
                "text_density": 0.77,
                "face_emphasis": 0.68,
                "shock_indicator": 0.88,
            },
            "risk_seed": 0.9,
            "mismatch_seed": 0.78,
        },
        {
            "title": "This rescue trick works every time and nobody shows it",
            "description": "A miracle-claim packaging pattern that sells certainty, suppression, and a one-step reveal without credible evidence.",
            "tags": ["rescue trick", "works every time", "nobody shows"],
            "hashtags": ["#mustwatch", "#secret"],
            "transcript": "The presenter stretches out the reveal while promising impossible reliability and implying others deliberately hide the method.",
            "template_cluster": "miracle-rescue-trick",
            "thumbnail_signal": {
                "saturation": 0.84,
                "contrast": 0.78,
                "text_density": 0.73,
                "face_emphasis": 0.63,
                "shock_indicator": 0.83,
            },
            "risk_seed": 0.86,
            "mismatch_seed": 0.75,
        },
        {
            "title": "Source-cited committee explainer and document timeline",
            "description": "A documentary-style explainer that walks through named documents, dates, and what is actually confirmed.",
            "tags": ["source-cited", "committee", "explainer"],
            "hashtags": ["#explainer", "#documents"],
            "transcript": "This source-cited explainer reviews the hearing timeline, the released documents, and the claims that can be substantiated.",
            "template_cluster": "committee-document-explainer",
            "thumbnail_signal": {
                "saturation": 0.33,
                "contrast": 0.37,
                "text_density": 0.16,
        ...
        {
            "title": "Acoustic live session and mastering notes",
            "description": "A music upload where the packaging is expressive but the transcript and structure remain consistent with a live session release.",
            "tags": ["acoustic", "live session", "mastering"],
            "hashtags": ["#music", "#livesession"],
            "transcript": "The singer compares the acoustic arrangement, the vocal takes, and the mastering choices from the live session.",
            "template_cluster": "acoustic-live-mastering",
            "thumbnail_signal": {
                "saturation": 0.52,
                "contrast": 0.41,
                "text_density": 0.17,
        ...
        {
            "title": "Museum installation walkthrough and sketchbook notes",
            "description": "An art-focused upload covering process, exhibition layout, and non-literal visual choices without deceptive packaging pressure.",
            "tags": ["museum", "installation", "sketchbook"],
            "hashtags": ["#art", "#museum"],
            "transcript": "The artist explains the installation layout, the sketchbook studies, and the material choices used for the exhibition pieces.",
            "template_cluster": "museum-installation-walkthrough",
            "thumbnail_signal": {
                "saturation": 0.44,
                "contrast": 0.39,
                "text_density": 0.14,
        ...
        {
            "title": "Spoof press conference sketch with obvious joke cues",
            "description": "A satire format that performs a fake briefing while making the joke framing explicit through dialogue and delivery.",
            "tags": ["spoof", "press conference", "satire"],
            "hashtags": ["#satire", "#spoof"],
            "transcript": "The sketch breaks character, exaggerates the claims, and signals repeatedly that the press conference is a parody.",
            "template_cluster": "spoof-press-briefing",
            "thumbnail_signal": {
                "saturation": 0.57,
                "contrast": 0.5,
                "text_density": 0.27,
        ...
        {
            "title": "Patch route breakdown and challenge build comparison",
            "description": "A gaming analysis format with real gameplay footage, route discussion, and a build comparison grounded in the patch notes.",
            "tags": ["patch route", "challenge build", "comparison"],
            "hashtags": ["#gaming", "#patchnotes"],
            "transcript": "The host runs the challenge route, compares the loadouts, and then maps the changes back to the patch notes.",
            "template_cluster": "patch-route-comparison",
            "thumbnail_signal": {
                "saturation": 0.64,
                "contrast": 0.55,
                "text_density": 0.23,
                "face_emphasis": 0.21,
                "shock_indicator": 0.16,
            },
            "risk_seed": 0.18,
            "mismatch_seed": 0.12,
        },
